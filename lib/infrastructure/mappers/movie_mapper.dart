...
class MovieMapper {
  static Movie movieDBToEntity(MoviedbDataResponse moviedb) => Movie(
    adult: moviedb.adult,
    backdropPath: moviedb.backdropPath!=''?'https://image.tmdb.org/t/p/w500${moviedb.backdropPath}':'https://png.pngtree.com/png-vector/20190820/ourmid/pngtree-no-image-vector-illustration-isolated-png-image_1694547.jpg',
    genreIds: moviedb.genreIds.map((toElement)=>toElement.toString()).toList(),
    id: moviedb.id,
